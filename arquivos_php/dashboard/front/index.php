...
<!-- Mirrored from themesbrand.com/velzon/html/default/nft-landing.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 24 Jun 2022 20:41:20 GMT -->
<head>
            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    <ul class="navbar-nav mx-auto mt-2 mt-lg-0" id="navbar-example">
                        ...
                        <li class="nav-item">
                            <a class="nav-link" href="#testimonial">What People Say</a>
                        </li>
                    </ul>

                    <div class="">
                    <a href="apps-nft-explore.html" class="btn btn-danger">Sign In <i class="ri-arrow-right-line align-middle ms-1"></i></a>
                    </div>
                </div>
                    ...
                    <div class="col-lg-8 col-sm-10">
                        <div class="text-center">
                            ...
                            <div class="hstack gap-2 justify-content-center">
                                <a href="apps-nft-create.html" class="btn btn-primary">Get Started <i class="ri-arrow-right-line align-middle ms-1"></i></a>
                    ...
                    <div class="col-sm-6">
                        ...
                        <div>
                            <p class="copy-rights mb-0">
                                <script> document.write(new Date().getFullYear()) </script> © Paywell - All Rights Reserved
                            </p>
                        </div>
                    </div>
                    <div class="col-sm-6">
...
<!-- Mirrored from themesbrand.com/velzon/html/default/nft-landing.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 24 Jun 2022 20:41:22 GMT -->
</html>

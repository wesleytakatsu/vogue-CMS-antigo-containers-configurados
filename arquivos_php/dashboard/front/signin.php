                                ...
                                <div class="col-lg-6">
                                    <div class="p-lg-5 p-4">
                                        ...
                                        <div class="mt-5 text-center">
                                            <p class="mb-0">Forgot Password ? <a href="auth-signup-cover.html" class="fw-semibold text-primary text-decoration-underline"> click here.</a> </p>
                                        </div>
                                    </div>
                                </div>
                                <!-- end col -->
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="text-center">
                            <p class="mb-0">&copy;
                                <script>document.write(new Date().getFullYear())</script> Paywell. Crafted with <i class="mdi mdi-heart text-danger"></i> by Hillsofts Tech
                            </p>
                        </div>
                    </div>
                </div>
